		...
		<div class="example-box-wrapper">
	        <form method="post" class="form-horizontal bordered-row" id="dynamic_form" data-parsley-validate>
	        	...
	        	<div class="form-group">
	                ...
	                <div class="col-sm-6">
	                	<input name="nama_image_galeri" id="nama_image_galeri" type="text" class="form-control" placeholder="Nama..." />
	                </div>
	            </div>
	            <div class="form-group">
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-6">
	                	<input name="keterangan_image_galeri" id="keterangan_image_galeri" type="text" class="form-control" placeholder="Keterangan..." />
	                </div>
	            </div>
