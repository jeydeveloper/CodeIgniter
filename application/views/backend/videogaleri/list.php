		...
		<div class="example-box-wrapper">
	        <form method="post" class="form-horizontal bordered-row" id="dynamic_form" data-parsley-validate>
	        	...
	        	<div class="form-group">
	                ...
	                <div class="col-sm-6">
	                	<input name="nama_video_galeri" id="nama_video_galeri" type="text" class="form-control" placeholder="Nama..." />
	                </div>
	            </div>
	            <div class="form-group">
	                <label class="col-sm-3 control-label">URL</label>
	                <div class="col-sm-6">
	                	<input name="url_video_galeri" id="url_video_galeri" type="text" class="form-control" placeholder="URL..." />
	                </div>
	            </div>
	            <div class="form-group">
	                <label class="col-sm-3 control-label">Keterangan</label>
	                <div class="col-sm-6">
	                	<input name="keterangan_video_galeri" id="keterangan_video_galeri" type="text" class="form-control" placeholder="Keterangan..." />
	                </div>
	            </div>
...
function fillFormData(data) {
	$('#id').val(data.id_video_galeri);
	$('#nama_video_galeri').val(data.nama_video_galeri);
	$('#url_video_galeri').val(data.url_video_galeri);
	$('#keterangan_video_galeri').val(data.keterangan_video_galeri);
}

function emptyFormData() {
	$('#id').val('');
	$('#nama_video_galeri').val('');
	$('#url_video_galeri').val('');
	$('#keterangan_video_galeri').val('');
}
