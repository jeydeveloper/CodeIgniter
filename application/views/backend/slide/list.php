		...
		<div class="example-box-wrapper">
	        <form method="post" class="form-horizontal bordered-row" id="dynamic_form" data-parsley-validate>
	        	...
	        	<div class="form-group">
	                ...
	                <div class="col-sm-6">
	                	<input name="nama_slide" id="nama_slide" type="text" class="form-control" placeholder="Nama..." />
	                </div>
	            </div>
	            <div class="form-group">
	                <label class="col-sm-3 control-label">URL</label>
	                <div class="col-sm-6">
	                	<input name="url_slide" id="url_slide" type="text" class="form-control" placeholder="URL..." />
	                </div>
	            </div>
	            <div class="form-group">
	                <label class="col-sm-3 control-label">Mulai Slide</label>
	                <div class="col-sm-6">
	                	<input name="mulai_slide" id="mulai_slide" type="text" class="form-control" placeholder="Mulai slide..." />
	                </div>
	            </div>
	            <div class="form-group">
	                <label class="col-sm-3 control-label">Akhir Slide</label>
	                <div class="col-sm-6">
	                	<input name="akhir_slide" id="akhir_slide" type="text" class="form-control" placeholder="Akhir slide..." />
	                </div>
	            </div>
	            <div class="form-group">
	                <label class="col-sm-3 control-label">Is Actived</label>
	                <div class="col-sm-6">
	                	<input name="isactive_slide" id="isactive_slide" type="text" class="form-control" placeholder="Is Actived..." />
	                </div>
	            </div>
...
function fillFormData(data) {
	...
	$('#nama_slide').val(data.nama_slide);
	$('#url_slide').val(data.url_slide);
	$('#mulai_slide').val(data.mulai_slide);
	$('#akhir_slide').val(data.akhir_slide);
	$('#isactive_slide').val(data.isactive_slide);
}
