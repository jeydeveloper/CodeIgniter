...
class Backend_videogaleri extends CI_Controller {
	public function index()
	{
		$data['api_url'] = base_url('api/video_galeri');
		$data['page_title'] = 'List Menu';
		$data['column_list'] = $this->get_show_column();
		$this->load->view('backend/header');
		$this->load->view('backend/content', ['page_content' => $this->load->view('backend/videogaleri/list', $data, true)]);
	}
	public function add()
	{
		$this->load->view('backend/header');
